...
//
wire	[`TC_AW+`TC_BSW+1+`TC_DW-1:0]   i0_in_common;
wire	[1:0]	                        i0_in_ctrl;
...
//
assign i0_in_common = {i0_wb_adr_i, i0_wb_sel_i, i0_wb_we_i, i0_wb_dat_i};
assign i0_in_ctrl = {i0_wb_cyc_i, i0_wb_stb_i};
assign {i0_wb_dat_o, i0_wb_ack_o} = i0_out;

//
// Group WB target 0 i/f inputs and outputs
//
assign {t0_wb_adr_o, t0_wb_sel_o, t0_wb_we_o, t0_wb_dat_o} = i0_in_common;
assign t0_in = {t0_wb_dat_i, t0_wb_ack_i};

//
// Group WB target 1 i/f inputs and outputs
//
assign {t1_wb_adr_o, t1_wb_sel_o, t1_wb_we_o, t1_wb_dat_o} = i0_in_common;
...
//
assign {t0_wb_cyc_o, t0_wb_stb_o} = req_t[0] ? i0_in_ctrl : {2'b00};
assign {t1_wb_cyc_o, t1_wb_stb_o} = req_t[1] ? i0_in_ctrl : {2'b00};
